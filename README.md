...
This project is an end-to-end retail sales analytics dashboard built in Power BI to analyze customer behavior, sales performance, product trends, and regional sales activity. The dashboard transforms raw transactional data into actionable business insights through interactive visualizations, KPI tracking, and demographic analysis. The analysis is based on a retail dataset containing over 287,000 transactions and 86,000 customers.
